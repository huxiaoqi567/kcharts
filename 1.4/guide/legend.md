...
<html>
  ...
  <body>
    ...
    <script charset="utf-8" src="http://a.tbcdn.cn/s/kissy/1.4.0/kissy-min.js"></script>
    <script type="text/javascript">

KISSY.use("gallery/kcharts/1.4/raphael/index,gallery/kcharts/1.4/legend/index,dom,event",function(S,Raphael,Legend,D,E){
  var $con = S.one("#J_Con")
    , $box = S.one("#J_Box")
