/**
 * @fileOverview KChart 1.4  barchart
 ...
 */
;
KISSY.add('gallery/kcharts/1.4/barchart/index', function(S, Node, Base, Template, BaseChart, Raphael, Color, HtmlPaper, Legend, Theme, Touch, Tip, Evt, Cfg) {
	var $ = S.all,
		clsPrefix = "ks-chart-",
