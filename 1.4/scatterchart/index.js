/**
 * @fileOverview KChart 1.4  scatterchart
 * @author huxiaoqi567@gmail.com
 */
;
KISSY.add("gallery/kcharts/1.4/scatterchart/index", function(S, Base, Node, D, Evt, Template, BaseChart, Raphael, ColorLib, HtmlPaper, Legend, Theme, touch, Tip, Cfg,graphTool) {
	var $ = S.all,
		clsPrefix = "ks-chart-",
