 ...
 * sector数据处理
 * */
;KISSY.add("gallery/kcharts/1.4/piechart/util",function(S,Sector,Color,Raphael){
  ...
  requires:["gallery/kcharts/1.4/piechart/sector","gallery/kcharts/1.4/tools/color/index","gallery/kcharts/1.4/raphael/index"]
});
