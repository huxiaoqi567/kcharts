// -*- coding: utf-8; -*-
;KISSY.add("gallery/kcharts/1.4/piechart/index",function(S,Util,Sector,Animate,Labels,Raphael,Color,Base,E,D){
   var COLOR_TPL = "{COLOR}";
   function render(){
     this.destroy();
   ...
   var methods = {
     ...
     onafterrender:function(){
       ...
       if(config){
         ...
         S.use("gallery/kcharts/1.4/legend/index",function(S,Legend){
     ...
     renderTip:function(tipconfig){
       ...
       S.use("gallery/kcharts/1.4/tip/index",function(S,Tip){
